...
#
# DoomSat override of lib/fprime/default/config/FpConstants.fpp: the com buffer is
# widened from 512 to 1000 bytes so one FrameChunk telemetry record (970-byte value)
# fits in one packet. TmFrameFixedSize (1024) must stay >= this + 13.
# ======================================================================
...
constant FW_COM_BUFFER_MAX_SIZE = 1000
